...
- **PHP 8.4** with common extensions (GD, PDO, BCMath, Redis, etc.)
...
1. **Base Image**: Uses `ghcr.io/quantcdn-templates/app-apache-php` for consistency
...
│   ├── quant/
│   │   ├── entrypoints/   # Startup scripts for Quant Cloud
│   │   └── php.ini.d/     # Custom PHP configuration
│   └── docker-entrypoint.sh # Local development entrypoint
├── quant/
│   └── meta.json          # Template metadata
├── setup.sh               # Script to regenerate Laravel app
├── dev-php.ini            # Development PHP settings
